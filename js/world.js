...
// ============================================================
const DIALOG = {
  elder_pre: "AH... RUA OF THE EMBER\nTAIL. THE GLOOM KNIGHT\nSTOLE THE VERDANT CROWN.\nOUR FORESTS WITHER.",
  elder_sword: "TAKE MY OLD BLADE. IT'S\nDANGEROUS TO WALK THE\nWILD UNARMED.",
  elder_post: "THE RUINS LIE NORTH OF\nTHE CROSSROADS. LIGHT\nYOUR WAY, AND TRUST\nYOUR TAIL.",
  granny1: "MY KNEES ACHE WHEN\nGHOSTS ARE ABOUT. THE\nCRYPT IN THE GRAVEYARD\nHIDES MORE THAN BONES...\nIF ONLY YOU HAD A BOMB.",
  granny2: "BUSHES HIDE GEMS,\nDEARIE. SWING THAT\nSWORD AT EVERYTHING.",
  kid: "I SAW A FAIRY BY THE\nEAST SHORE! SHE FIXED MY\nSCRAPED KNEE WITH ONE\nWINK!",
  farmer: "THE RUINS' HALLS ARE\nDARK AS A BADGER'S DEN.\nBRING A LANTERN... OR\nFIND ONE INSIDE.",
  shopkeep: "FINEST WARES IN\nBROOKHOLLOW! WALK INTO\nWHAT YOU FANCY, IF YOUR\nPOUCH JINGLES.",
  fairy: "REST, LITTLE EMBER.\nYOUR WOUNDS ARE MENDED.",
  ...
  get_sword: "YOU GOT THE ELDER'S\nBLADE! PRESS Z TO SWING.",
  get_lantern: "YOU FOUND THE LANTERN!\nDARK HALLS NOW GLOW\nAROUND YOU.",
  get_bow: "YOU GOT THE FERN BOW!\nFIRE ARROWS WITH X. THE\nGLOOM KNIGHT'S SHIELD\nFEARS THEM.",
  get_bosskey: "THE GLOOM KEY...\nIT HUMS WITH SORROW.",
  get_key: "A SMALL KEY!",
  get_heartcont: "A HEART VESSEL!\nYOUR LIFE GROWS.",
  get_bombs: "BOMBS! SET THEM WITH X.\nCRACKED ROCK CRUMBLES.",
  get_gems: "A STASH OF GEMS!",
  get_crown: "THE VERDANT CROWN\nIS YOURS!"
};
